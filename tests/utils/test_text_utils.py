...
def test_multiple_encodings():
    ...
    lines = [
        (b"Country,Partner,Partner ID,Partner Status,Advertiser,Advertiser ID,"
         b"Advertiser Status,Advertiser Integration Code,Insertion Order,"
         b"Insertion Order ID,Insertion Order Status,Insertion Order "
         b"Integration Code,Line Item,Line Item ID,Line Item Status,"
         b"Line Item Integration Code,Targeted Data Providers,"
    ...
    expected_dict = {
        ...
        "Line Item": (
            "YR_Sanofi_Allegra_201910_Consideration_DV360_Precision_OA_Native"
            "-Ads_DV-Affinity-Health_Desktop_BR"
        ),
