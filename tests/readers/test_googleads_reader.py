...
from nck.readers.googleads_reader import DATEFORMAT, GoogleAdsReader
...
class GoogleAdsReaderTest(TestCase):
    ...
    def test_read_data(self, mock_report, mock_query):
        ...
        expected = [
            {"AdGroupName": "ad_group_example", "Date": "2019-01-01", "Impressions": "0"},
            {"AdGroupName": "ad_group_example", "Date": "2019-01-01", "Impressions": "4"},
        ]
    ...
    def test_read_data_and_include_account_id(self, mock_report, mock_query):
        ...
        expected = [
            {"AdGroupName": "ad_group_example", "AccountId": "123-456-7890", "Date": "2019-01-01", "Impressions": "0"},
            {"AdGroupName": "ad_group_example", "AccountId": "123-456-7890", "Date": "2019-01-01", "Impressions": "4"},
        ]
    ...
    def test_add_period_to_report_definition_works_properly(self):
        consistent_report_definition = {"date_range_type": "YESTERDAY", "start_date": None, "end_date": None}
        report_definition = self.get_report_definition(consistent_report_definition["date_range_type"])
        temp_kwargs = self.kwargs.copy()
        temp_kwargs.update(consistent_report_definition)
        self.assertIsNone(GoogleAdsReader(**temp_kwargs).add_period_to_report_definition(report_definition))
