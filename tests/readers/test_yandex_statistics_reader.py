...
class TestYandexStatisticsReader(unittest.TestCase):
    @parameterized.expand(
        [
            ...
            (
                ...
                {
                    "params": {
                        "SelectionCriteria": {"DateFrom": "2020-03-05", "DateTo": "2020-03-25"},
                        "Page": {"Limit": 25},
                        "FieldNames": ["AdFormat", "AdGroupId"],
                        "ReportName": "stats_report_2020-03_25",
                        "ReportType": "AD_PERFORMANCE_REPORT",
            ...
            (
                ...
                {
                    "report_language": "en",
                    "filters": (("AdGroupId", "EQUALS", ["1"]), ("CampaignId", "IN", ["1", "2"])),
                    "max_rows": 25,
                    "date_start": datetime.datetime(2020, 3, 5, 0, 0),
                    "date_stop": datetime.datetime(2020, 3, 25, 0, 0),
                },
                False,
                {
                    "params": {
                        "SelectionCriteria": {
                            ...
                            "DateTo": "2020-03-25",
                            "Filter": [
                                {"Field": "AdGroupId", "Operator": "EQUALS", "Values": ["1"]},
    ...
    def test_get_query_body(self, date_range, kwargs, include_vat, expected_query_body):
    ...
    def test_request_headers(self, report_language):
        ...
        self.assertDictEqual(
            {"skipReportSummary": "true", "Accept-Language": report_language}, reader._build_request_headers()
        )
    ...
    def test_custom_dates_correctly_set(self, date_range, start_date, stop_date, expected):
        ...
        self.assertDictEqual(expected, reader._add_custom_dates_if_set())
    ...
    @parameterized.expand(
        [
            ...
            ("CUSTOM_DATE", None, None, "Missing at least one date. Have you set start and stop dates?"),
            (
                "CUSTOM_DATE",
                datetime.datetime(2020, 1, 1),
                None,
    ...
    def test_custom_dates_not_correctly_set(self, date_range, start_date, stop_date, error_message_expected):
        reader = YandexStatisticsReader(
            "123",
            ("AdFormat", "AdGroupId"),
            "AD_PERFORMANCE_REPORT",
