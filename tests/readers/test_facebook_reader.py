...
class FacebookReaderTest(TestCase):
    ...
    @parameterized.expand(
        [
            ...
            ("missing_breakdown", {"ad_insights": True, "field": ["age"], "breakdown": []}),
            ("missing_action_breakdown",{"ad_insights": True, "field": ["actions[action_type:link_click]"], "action_breakdown": []}),
            ("creative_level_for_adinsights_query", {"ad_insights": True, "object_type": "creative", "level": "creative"}),
            ("breakdown_for_object_node_query", {"ad_insights": False, "breakdown": ["age"]}),
            ("action_breakdown_for_object_node_query", {"ad_insights": False, "action_breakdown": ["action_type"]}),
            ("time_range_for_object_node_query", {"ad_insights": False, "level": "account", "start_date": "2020-01-01", "end_date": "2020-01-01"}),
            ("date_preset_for_object_node_query", {"ad_insights": False, "level": "account", "date_preset": "last_30d"}),
            ("time_increment_for_object_node_query", {"ad_insights": False, "time_increment": "1"})
        ]
    )
    ...
    def test_get_field_paths(self):
        ...
        expected = [["impressions"], ["link_url_asset", "website_url"], ["actions", "action_type:link_click"]]
    ...
    def test_read_with_ad_insights_query(self, mock_query_ad_insights):
        ...
        expected = [{"date_start": "2020-01-01", "impressions": "1"}, {"date_start": "2020-01-01", "impressions": "2"}]
    ...
    def test_read_with_object_node_query(self, mock_query_object_node):
        ...
        data = next(FacebookReader(**temp_kwargs).read())
        expected = [{"id": "123456789", "status": "ACTIVE"}, {"id": "987654321", "status": "PAUSED"}]
    ...
    @parameterized.expand(
        [
            ...
            (
                "action_breakdown_field_without_filters",
                {"field":["actions[action_type:link_click][action_device:iphone]"],"action_breakdown":["action_type", "action_device"]},
                {"actions": [
